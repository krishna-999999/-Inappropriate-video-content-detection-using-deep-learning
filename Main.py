...
main = tkinter.Tk()
main.title("Inappropriate video content detection using deep learning")
...
font = ('times', 14, 'bold')
title = Label(main, text='Inappropriate VIDEO content detection USING DEEP LEARNING')
...
svmButton = Button(main, text="Run EfficientNet-SVM Algorithm", command=runExistingSVM)
